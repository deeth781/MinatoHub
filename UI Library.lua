...
local library = utility.table({theme = table.clone(themes.MinatoHub), folder = "MinatoHub 🐧", extension = "cfg", flags = {}, open = false, keybind = Enum.KeyCode.RightShift, mousestate = services.InputService.MouseIconEnabled, cursor = nil, holder = nil, connections = {}}, true)
...
function library:GetThemes()
	local themes = {"Default", "Midnight", "MinatoHub"}
...
function library:Load(options)
	...
	local theme = options.theme and options.theme or "MinatoHub"
