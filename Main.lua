...
if MinatoHubV2Loaded or MinatoHubV2Loading or MinatoHub then
	return
end

getgenv().MinatoHubV2Loading = true
...
local GUI = loadstring(game:HttpGet("https://raw.githubusercontent.com/Exunys/MinatoHub-V2/main/src/UI%20Library.lua"))()
...
ESP.Load()
Aimbot.Load()
getgenv().MinatoHubV2Loaded = true
getgenv().MinatoHubV2Loading = nil
